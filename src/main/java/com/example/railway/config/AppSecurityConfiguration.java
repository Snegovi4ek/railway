...
import com.example.railway.services.AppUserDetailsService;
...
public class AppSecurityConfiguration {
    ...
    public AppSecurityConfiguration(UserRepository userRepository) {
        ...
        log.info("Railway AppSecurityConfiguration initialized");
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        log.info("Railway SecurityFilterChain configured");
        return http.build();
    }
